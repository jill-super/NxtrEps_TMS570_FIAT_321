 ...
 *     Workspace:  C:/Synergy/EA3/Working/Fiasa_326_327/Fiasa_326_327_03.05.00/Fiasa_326_327_EPS_TMS570/Tools/AsrProject/Config/DCF/EPS.dcf
 *   ECU-Project:  EPS
 *
...
#  define Rte_IWrite_IoHwAb_ReadAdc_BattSwitched_Volt_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_IoHwAbstractionUsr_BattSwitched_Volt_f32.value = (data) \
  )
...
#  define Rte_IWrite_IoHwAb_ReadAdc_Batt_Volt_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_IoHwAbstractionUsr_Batt_Volt_f32.value = (data) \
  )
