/* -----------------------------------------------------------------------------
  ...
  Description: Configuration of DCM visible to any application.
               ...
               EcuDoc:       Nexteer_Electric_Power_Steering_P3272_P341_Next_Gen_A__FF_00_00_0002_00D2_P3272_P341_Next_Gen_A
...
/* -----------------------------------------------------------------------------
  C O P Y R I G H T
 -------------------------------------------------------------------------------
  Copyright (c) 2008-2017 by Vector Informatik GmbH. All rights reserved.
...
#define DCM_LCFG_MAJOR_VERSION                                       0x07u
#define DCM_LCFG_MINOR_VERSION                                       0x00u
...
typedef P2FUNC(Std_ReturnType, DCM_APPL_CODE, Dcm_DsdIndFuncPtrType)(uint8                           /* Sid */
                                                                    ,Dcm_MsgType                     /* ReqData */
                                                                    ,uint16                          /* ReqDataLen */
                                                                    ,uint8                           /* ReqType */
...
typedef P2FUNC (Std_ReturnType, DCM_APPL_CODE, Dcm_11_RtePermCallBackType) (uint8 /* resetType */, Dcm_NegativeResponseCodePtrType /* errorCodePrr */);
...
typedef P2FUNC (Std_ReturnType, DCM_APPL_CODE, Dcm_28_RtePermCallBackType) (uint8 /* subNetId */, uint8 /* msgType */,boolean /* rxState */, boolean /* txState */);
...
extern FUNC(void, DCM_CODE) DcmOnChgStateSecurityAccess(uint8_least stateGroupIdx, uint8 newStateIdx);
...
extern FUNC(void, DCM_CODE) Dcm_DspEcuReset(void);
extern FUNC(void, DCM_CODE) Dcm_DspPostEcuReset(Dcm_ConfirmationStatusType status);
extern FUNC(void, DCM_CODE) Dcm_DspClearDiagInfo(void);
extern FUNC(void, DCM_CODE) DiagSvc_DspPostClearDiagInfo(Dcm_ConfirmationStatusType status);	/* NEXTEER MANUAL EDIT */
...
extern FUNC(void, DCM_CODE) Dcm_DspCommunicationControl(void);
extern FUNC(void, DCM_CODE) Dcm_DspPostCommunicationControl(Dcm_ConfirmationStatusType status);
...
extern FUNC(void, DCM_CODE) Dcm_DspControlDtcSetting(void);
...
extern FUNC(void, DCM_CODE) Dcm_DspReadDtcRDTCSSBDTC(void);
extern FUNC(void, DCM_CODE) Dcm_DspReadDtcRDTCEDRBDN(void);
extern FUNC(void, DCM_CODE) Dcm_DspReadDtcRNODTCBSMR(void);
extern FUNC(void, DCM_CODE) Dcm_DspReadDtcRDTCBSMR(void);
extern FUNC(void, DCM_CODE) Dcm_DspReadDtcRSIODTC(void);
extern FUNC(void, DCM_CODE) Dcm_DspReadDtcRFCDTC(void);
extern FUNC(void, DCM_CODE) Dcm_DspReadDtcRMRCDTC(void);
...
extern VAR(Dcm_TimerCounterType, DCM_VAR_NOINIT) dcmTimerEngine[DCM_NUM_TIMERS_SIZE_DECL];

extern VAR(Dcm_PduRxTransportInfoType, DCM_VAR_NOINIT) dcmPduRxTransportInfo[DCM_DSL_NUM_TRANSP_OBJ_SIZE_DECL];

#if (DCM_DSL_SHARED_TX_CONN_ENABLED == STD_ON)
extern VAR(Dcm_PduTxTransportInfoType, DCM_VAR_NOINIT) dcmPduTxTransportInfo[DCM_DSL_NUM_TRANSP_OBJ_SIZE_DECL];
#else
/* Use shared resources */
# define dcmPduTxTransportInfo                                       dcmPduRxTransportInfo
#endif

extern VAR(Dcm_StateIdType, DCM_VAR_NOINIT) dcmCurrentStateInfo[2];
extern VAR(Dcm_MemDidHandleType, DCM_VAR_NOINIT) dcm22_DidList[1][10];
extern VAR(Dcm_RteDataLenType, DCM_VAR_NOINIT) dcm22_DidResLen[1][10];
extern VAR(Dcm_27_SecLevelStateMachineType, DCM_VAR_NOINIT) dcm27_SecLevelStateEngine[1];
...
extern CONST(uint8, DCM_CONST) dcmStateValuesSession[5];
extern CONST(uint8, DCM_CONST) dcmStateValuesSecurityAccess[2];
extern CONST(uint8, DCM_CONST) dcmDspServiceIdTypeList[13];
extern CONST(uint8, DCM_CONST) dcm10_SubFuncLookUpTable[6];
extern CONST(uint8, DCM_CONST) dcm11_SubFuncLookUpTable[3];
extern CONST(uint8, DCM_CONST) dcm19_SubFuncLookUpTable[10];
extern CONST(uint8, DCM_CONST) dcm19_UsedSnpshtRecIds[2];
extern CONST(uint8, DCM_CONST) dcm19_UsedExtDatRecIds[1];
extern CONST(uint8, DCM_CONST) dcm27_SubFuncLookUpTable[2];
extern CONST(uint8, DCM_CONST) dcm28_SubFuncLookUpTable[3];
extern CONST(uint8, DCM_CONST) dcm2F_SubFuncToCtrlTypeMap[4];
extern CONST(uint8, DCM_CONST) dcm31_SubFuncToCtrlTypeMap[4];
extern CONST(uint8, DCM_CONST) dcm85_SubFuncLookUpTable[3];
...
extern CONST(uint16, DCM_CONST) dcmDidLookUpTable[96];
extern CONST(uint16, DCM_CONST) dcmRidLookUpTable[13];
...
extern CONST(Dcm_StateMaskType, DCM_CONST) dcmServiceStateFilterPool[7][2];
extern CONST(Dcm_StateMaskType, DCM_CONST) dcmStateTransPrecondInfo[7][2];
extern CONST(Dcm_StateIdType, DCM_CONST) dcmStateTransTargetInfo[7][2];
extern CONST(Dcm_StateGroupInfoType, DCM_CONST) dcmStateGroupInfo[2];
extern CONST(Dcm_ServiceTableType, DCM_CONST) dcmDspServiceInfoTable[13];
extern CONST(Dcm_SessionControlInfoType, DCM_CONST) dcm10_ServiceInfoTable[5];
...
extern CONST(Dcm_11_RtePermCallBackType, DCM_CONST) dcm11_EcuResetPermFunc;

extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm11_ServiceInfoTable[2];
extern CONST(Dcm_19_SubFunctionInfoType, DCM_CONST) dcm19_ServiceInfoTable[9];
extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm22_DidStateInfoTable[90];
extern CONST(Dcm_MemDidHandleType, DCM_CONST) dcm22_DidHandleTable[91];
extern CONST(Dcm_22_ServiceInfoType, DCM_CONST) dcm22_ServiceInfoTable[90];
extern CONST(Dcm_SecAccessTableType, DCM_CONST) dcm27_ServiceInfoTable[1];
extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm28_StateInfoTable[2];
extern CONST(Dcm_28_RtePermCallBackType,  DCM_CONST) dcm28_ComControlPermFunc;

extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm2E_DidStateInfoTable[34];
extern CONST(Dcm_MemDidHandleType, DCM_CONST) dcm2E_DidHandleTable[35];
extern CONST(Dcm_2E_ServiceInfoType, DCM_CONST) dcm2E_ServiceInfoTable[34];
extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm2F_DidStateInfoTable[5];
extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm2F_SubFuncStateInfoTable[12];
extern CONST(Dcm_MemDidHandleType, DCM_CONST) dcm2F_DidHandleTable[6];
extern CONST(Dcm_2F_ServiceInfoType, DCM_CONST) dcm2F_ServiceInfoTable[12];
extern CONST(Dcm_2F_MemInstHandleType, DCM_CONST) dcm2F_DidControlTypeInfo[5][3];
extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm31_RidStateInfoTable[12];
extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm31_SubFuncStateInfoTable[16];
extern CONST(Dcm_31_ServiceInfoType, DCM_CONST) dcm31_ServiceInfoTable[16];
extern CONST(Dcm_MemRidInstHandleType, DCM_CONST) dcm31_ControlTypeInfo[12][3];
extern CONST(Dcm_StateFilterIndexType, DCM_CONST) dcm85_StateInfoTable[2];
