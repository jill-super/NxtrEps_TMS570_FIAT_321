...
#  define Rte_Call_ChkPtAp10_10msEnd_CP_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)3, (WdgM_CheckpointIdType)1))
#  define Rte_Call_ChkPtAp10_10msStart_CP_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)3, (WdgM_CheckpointIdType)0))
#  define Rte_Call_ChkPtAp10_2msEnd_CP_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)7, (WdgM_CheckpointIdType)1))
#  define Rte_Call_ChkPtAp10_2msStart_CP_CheckpointReached() (WdgM_CheckpointReached((WdgM_SupervisedEntityIdType)7, (WdgM_CheckpointIdType)0))
