...
CONST(TUNING_P_Str, CAL_CONST)k_TunSet3Per0_Cnt_Str = { {{FPM_InitFixedPoint_m(0.0, s4p11_T),FPM_InitFixedPoint_m(0.0, s4p11_T),
...
CONST(TUNING_P_Str, CAL_CONST)k_TunSet3Per1_Cnt_Str = { {{FPM_InitFixedPoint_m(0.0, s4p11_T),FPM_InitFixedPoint_m(0.0, s4p11_T),
	FPM_InitFixedPoint_m(0.0234375, s4p11_T),
	FPM_InitFixedPoint_m(0.03515625, s4p11_T),
	FPM_InitFixedPoint_m(0.05078125, s4p11_T),
	FPM_InitFixedPoint_m(0.0703125, s4p11_T),
