...
static VAR(uint8, NVM_PRIVATE_DATA) Rte_NvmBlock_LrnEOT_LearnedEOT_Crc_au8[2];
static VAR(uint8, NVM_PRIVATE_DATA) Rte_NvmBlock_AvgFricLrn_AvgFricLrnData_Crc_au8[2];


/* create the internal buffer of size NVM_INTERNAL_BUFFER_SIZE */
VAR(uint8, NVM_PRIVATE_DATA) NvM_InternalBuffer_au8[205];
#endif
...
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_TuningSetSelectData[];
...
extern VAR(uint8, NVM_APPL_DATA) Rte_LrnEOT_LearnedEOT[];
extern CONST(uint8, NVM_APPL_CONST) T_LearnedEOTInit_Cnt_str[];
extern VAR(uint8, NVM_APPL_DATA) Rte_AvgFricLrn_AvgFricLrnData[];
extern CONST(uint8, NVM_APPL_CONST) T_AvgFricLrnDataInit_Cnt_str[];
...
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_BootSwFingerPrintData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_AppSwFingerPrintData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_ECUSparePartNoData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_VINCurrentData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_EraseRoutineStatusData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_ProgrammingStatusData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_Sa_DigColPs_DigColPsEOL[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_ProxiConfigurationData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_ProxiCounterData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_CalSwFingerPrintData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_ECULifeTimeMinsData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_FirstDTCDetectMinsData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_FirstDTCDetectSecsData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_EOLConfigurationData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_ProgrammingAttemptCounterData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_VINOriginalData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_ECUSerialNumberData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_TotalOdometerData[];
extern VAR(uint8, NVM_APPL_DATA) Rte_DiagSvc_OdometerFlashProgData[];
...
#include "MemMap.h"
    ...
    ,{
        ...
        245u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
        NVM_BLOCK_NATIVE,/* Management Type */
    ...
    /* block descriptor user block Deprecated_NvmBlock_TrqCmdScl_TorqueCmdSF_Uls_f32 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Deprecated_NvmBlock_CmMtrCurr_ShCurrCal */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Deprecated_NvmBlock_LrnEOT_LearnedEOT */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Deprecated_NvmBlock_TrqCanc_CogTrqCal */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Deprecated_NvmBlock_AvgFricLrn_AvgFricLrnData */
    ,{
    ...
    /* block descriptor user block Deprecated_NvmBlock_DigHwTrqSENT_DigTrqTrim */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_TuningSetSelectData */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_TuningSetSelectData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Deprecated_NvmBlock_AbsHwPos_EOLVehCntrOffset1 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Deprecated_NvmBlock_TrqCanc_CogTrqRplComp */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Deprecated_NvmBlock_AstLmt_SteerAsstDefeat */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    ,{
        (NvM_RamAddressType)&Rte_LrnEOT_LearnedEOT /* pointer to the RAM data buffer */,
        &T_LearnedEOTInit_Cnt_str /* pointer to the ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        Rte_NvmBlock_LrnEOT_LearnedEOT_Crc_au8, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&Rte_AvgFricLrn_AvgFricLrnData /* pointer to the RAM data buffer */,
        &T_AvgFricLrnDataInit_Cnt_str /* pointer to the ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        Rte_NvmBlock_AvgFricLrn_AvgFricLrnData_Crc_au8, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_SupplierIdentifierData */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_SparePartNumberData */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_BootSwFingerPrint */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_BootSwFingerPrintData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_AppSwFingerPrint */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_AppSwFingerPrintData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_SupplierIdentification */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_ECUSparePartNo */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_ECUSparePartNoData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_VehicleManfSwNo */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_VehicleManfHwNo */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_VINCurrent */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_VINCurrentData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_VehicleIdentificationNo */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_DiagnosticIdentificationNo */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_ExhaustRegNo */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_SwVersionNo */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_FeeInitFlag */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_EraseRoutineStatus */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_EraseRoutineStatusData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_ProgrammingStatus */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_ProgrammingStatusData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_NvValidityFlag */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0760u,     /* NV block Base number (defined by FEE/EA) */
        1u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_ApplValidityFlag */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_UpdateFlag */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x07A0u,     /* NV block Base number (defined by FEE/EA) */
        1u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Deprecated_Boot_ProgAttemptsCounter */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_ProgrammingAttemptCounterData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_ResetResponse */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x07E0u,     /* NV block Base number (defined by FEE/EA) */
        2u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_LbAddress */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_LbLength */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0820u,     /* NV block Base number (defined by FEE/EA) */
        4u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_NvCrc */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Rte_NvmBlock_Sa_DigColPs_DigColPsEOL */
    ,{
        (NvM_RamAddressType)&NvMP_Rte_Sa_DigColPs_DigColPsEOL /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0860u,     /* NV block Base number (defined by FEE/EA) */
        20u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_AdminData */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x08A0u,     /* NV block Base number (defined by FEE/EA) */
        1u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_EventData */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_PrimaryEntry1 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x08E0u,     /* NV block Base number (defined by FEE/EA) */
        1u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_PrimaryEntry2 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_PrimaryEntry3 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0920u,     /* NV block Base number (defined by FEE/EA) */
        1u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_PrimaryEntry4 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_PrimaryEntry5 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0960u,     /* NV block Base number (defined by FEE/EA) */
        1u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_PrimaryEntry6 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_PrimaryEntry7 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x09A0u,     /* NV block Base number (defined by FEE/EA) */
        1u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Deprecated_Dem_NvBlock_PrimaryEntry8 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
    ...
    /* block descriptor user block Deprecated_Rte_NvmBlock_DiagSvc_ProxiConfigurationData */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x09E0u,     /* NV block Base number (defined by FEE/EA) */
        6u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Dem_NvBlock_AdminData */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvAdminData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Dem_NvBlock_EventData */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvEventStatusData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0A20u,     /* NV block Base number (defined by FEE/EA) */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry1 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_1 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry2 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_2 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0A60u,     /* NV block Base number (defined by FEE/EA) */
        40u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry3 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_3 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry4 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_4 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0AA0u,     /* NV block Base number (defined by FEE/EA) */
        40u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry5 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_5 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry6 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_6 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0AE0u,     /* NV block Base number (defined by FEE/EA) */
        40u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry7 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_7 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry8 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_8 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0B20u,     /* NV block Base number (defined by FEE/EA) */
        40u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry9 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_9 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Dem_NvBlock_PrimaryEntry10 */
    ,{
        (NvM_RamAddressType)&Dem_Cfg_NvPrimaryEntry_10 /* pointer to the RAM data buffer */,
        &Dem_Cfg_NvPrimaryEntry_Zero /* pointer to the ROM default data block */,
        Dem_NvM_JobFinished, /* Job End notification callback (application defined) */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0B60u,     /* NV block Base number (defined by FEE/EA) */
        40u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_ProxiConfigurationData */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_ProxiConfigurationData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0B80u,     /* NV block Base number (defined by FEE/EA) */
        255u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
        NVM_BLOCK_NATIVE,/* Management Type */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_ProxiCounter */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_ProxiCounterData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0BA0u,     /* NV block Base number (defined by FEE/EA) */
        1u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_CalSwFingerPrint */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_CalSwFingerPrintData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_ECULifeTimeMins */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_ECULifeTimeMinsData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0BE0u,     /* NV block Base number (defined by FEE/EA) */
        4u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_FirstDTCDetectMins */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_FirstDTCDetectMinsData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_FirstDTCDetectSecs */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_FirstDTCDetectSecsData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0C20u,     /* NV block Base number (defined by FEE/EA) */
        2u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_EOLConfigData */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_EOLConfigurationData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_ProgAttemptsCounter */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_ProgrammingAttemptCounterData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0C60u,     /* NV block Base number (defined by FEE/EA) */
        8u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_VINOriginal */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_VINOriginalData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_ECUSerialNumber */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_ECUSerialNumberData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0CA0u,     /* NV block Base number (defined by FEE/EA) */
        16u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_TotalOdometer */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_TotalOdometerData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DiagSvc_OdometerFlashProg */
    ,{
        (NvM_RamAddressType)&Rte_DiagSvc_OdometerFlashProgData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0CE0u,     /* NV block Base number (defined by FEE/EA) */
        2u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_DIDF100 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0D00u,     /* NV block Base number (defined by FEE/EA) */
        7u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_DIDF181 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0D20u,     /* NV block Base number (defined by FEE/EA) */
        14u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_DIDF182 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0D40u,     /* NV block Base number (defined by FEE/EA) */
        14u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_DIDF187 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0D60u,     /* NV block Base number (defined by FEE/EA) */
        11u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_DIDF188 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0D80u,     /* NV block Base number (defined by FEE/EA) */
        11u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_DIDF191 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0DA0u,     /* NV block Base number (defined by FEE/EA) */
        11u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
    ...
    /* block descriptor user block Rte_NvmBlock_Boot_DIDF192 */
    ,{
        (NvM_RamAddressType)NULL_PTR /* Non permanent RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0DC0u,     /* NV block Base number (defined by FEE/EA) */
        11u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
