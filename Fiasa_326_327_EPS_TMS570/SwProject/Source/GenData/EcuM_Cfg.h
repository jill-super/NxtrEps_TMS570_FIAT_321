 ...
 *                                ESCAN00052958 No changes here
 *                                ESCAN00054560 No changes here
 *                                ESCAN00042868 No changes here
 *                                ESCAN00052498 No changes here
 *                                ESCAN00054279 added new generation tag for ECUM_IDENTITY_MANAGER_CONFIG
 ...
 *                                ESCAN00058258 Added new parameters to enable and disable reporting of certain Dem events
 *                                ESCAN00058263 No changes here
 *                                ESCAN00058340 No changes here
 * 07.03.00   2012-06-23  Rpp     ESCAN00059469 Added precompile switch ECUM_ON_STATE_CHANGE_CALLOUT
 ...
 * 07.04.01   2013-01-03  Vjn     ESCAN00063627 Added define EcuM_ShutdownOS for redirection of ShutdownOS
 * 07.05.00   2013-04-08  Vjn     ESCAN00062418 Added define ECUM_AMD_RUNTIME_MEASUREMENT
 *                                ESCAN00066486 Added define ECUM_CHECKWAKEUP_OPTIMIZATION
 *                                ESCAN00067036 No changes here
 * 07.06.00   2013-10-08  Vjn     ESCAN00070294 Added Define ECUM_NUMBER_OF_CORES which indicates a MultiCore Ecu
 ...
 *********************************************************************************************************************/
# define ECUM_CFG_MAJOR_VERSION    (7u)
# define ECUM_CFG_MINOR_VERSION    (6u)
...
# define ECUM_DEV_ERROR_DETECT                                        /*<ECUM_DEV_ERROR_DETECT/>*/ (STD_OFF)
...
# define ECUM_AMD_RUNTIME_MEASUREMENT                                 /*<ECUM_AMD_RUNTIME_MEASUREMENT/>*/ (STD_OFF)
# define ECUM_CHECKWAKEUP_OPTIMIZATION                                /*<ECUM_CHECKWAKEUP_OPTIMIZATION/>*/ (STD_OFF)

# define ECUM_NUMBER_OF_CORES                                         /*<ECUM_NUMBER_OF_CORES/>*/ (1u)
...
# define ECUM_ON_ERROR_HOOK                                           /*<ECUM_ON_ERROR_HOOK/>*/ (STD_ON)
# define ECUM_ON_STATE_CHANGE_CALLOUT                                 /*<ECUM_ON_STATE_CHANGE_CALLOUT/>*/ (STD_OFF)
...
#   define ECUM_CHECK_CONFIG_TYPE                                     /*<ECUM_CHECK_CONFIG_TYPE/>*/ (STD_OFF)
...
#  define EcuM_Det_Errorhook(EcuM_FunctionId, EcuM_ErrorCode)         /*<ECUM_DET_ERRORHOOK_FUNCTION>*//*</ECUM_DET_ERRORHOOK_FUNCTION>*/
# else
...
# define ECUM_ENABLE_PROD_ERROR_REPORTING                             /*<ECUM_ENABLE_PROD_ERROR_REPORTING/>*/ (STD_ON)
# define ECUM_REPORT_ALL_RUN_REQUESTS_KILLED                          /*<ECUM_REPORT_ALL_RUN_REQUESTS_KILLED/>*/ (STD_ON)
# define ECUM_REPORT_RAM_CHECK_FAILED                                 /*<ECUM_REPORT_RAM_CHECK_FAILED/>*/ (STD_ON)

# define ECUM_CONFIG_VARIANT                                          /*<ECUM_CONFIG_VARIANT/>*/ (ECUM_VARIANT_PRECOMPILE)
# define ECUM_IDENTITY_MANAGER_CONFIG                                 /*<ECUM_IDENTITY_MANAGER_CONFIG/>*/ (STD_OFF)
...
#define EcuM_ShutdownOS()                                               /*<ECUM_SHUTDOWN_OS_FUNCTION/>*/ ShutdownOS(E_OK)

/*<ECUM_DEFAULT_SHUTDOWN_TARGET>*/
#define ECUM_DEFAULT_SHUTDOWN_STATE         (ECUM_STATE_SLEEP)
...
#define ECUM_MAX_WAKEUP_SOURCE_VALUE        (32u)
#define ECUM_MAX_SLEEP_MODES                (1u)
#define ECUM_MAX_WAKEUP_SOURCES             (6u)
