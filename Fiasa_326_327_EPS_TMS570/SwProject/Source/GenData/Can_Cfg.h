...
/* START of Checksum exclude for
  - DrvCan__baseAsrPrecompileCRC */
#define DRVCAN__BASESASRDLL_VERSION          0x0403u
#define DRVCAN__BASESASRDLL_RELEASE_VERSION  0x06u

#define CAN_GEN_BASE_VERSION                 0x0106u
#define CAN_ASR_VERSION                      0x0300u
/* END of Checksum exclude for
  - DrvCan__baseAsrPrecompileCRC */
#define DrvCan_Tms470DcanAsrDLL_VERSION      0x0207u
#define DrvCan_Tms470DcanAsrDLL_RELEASE_VERSION 0x01u
...
#define CAN_SUPPORT_MIXED_ID STD_ON
/* -----------------------------------------------------------------------------
...
/* START of Checksum exclude for
  - DrvCan__baseAsrPrecompileCRC */
#define kCanNumberOfUsedTxCANObjects         8u
#ifndef C_DRV_INTERNAL
...
#define Can_CanHardwareObject_7              7
...
#define Can_CanHardwareObject_17             18
#define Can_CanHardwareObject_18             19
#define Can_CanHardwareObject_19             20
#define Can_CanHardwareObject_20             21
#define Can_CanHardwareObject_21             22
#define Can_CanHardwareObject_22             23
/* END of Checksum exclude for
  - DrvCan__baseAsrPrecompileCRC */
...
/* END of Checksum exclude for
  - DrvCan__baseAsrPrecompileCRC */
typedef VAR(uint8, TYPEDEF) CanHwObjIndivPolling_dim_type[64];
typedef P2CONST(CanHwObjIndivPolling_dim_type, TYPEDEF, CAN_CONST_PBCFG) CanHwObjIndivPolling_TabPtrType;
/* END of Checksum exclude for
  - DrvCan__baseAsrPrecompileCRC */
...
typedef struct Can_ConfigTypeTag
{
  ...
  CanInitBasicMskPtrType CanInitBasicMsk1Ptr;
  CanInitBasicMskPtrType CanInitBasicMsk2Ptr;
  CanInitBasicCodPtrType CanInitBasicCod1Ptr;
  CanInitBasicCodPtrType CanInitBasicCod2Ptr;
...
extern CONST(Can_MailboxType, CAN_CONST_PBCFG) CanMailbox[22]; /* PRQA S 3684 */ /* MD_Can_3684 */
...
extern CONST(uint16, CAN_CONST_PBCFG) CanInitBRP_Reg[1];
extern CONST(uint16, CAN_CONST_PBCFG) CanInitBitTiming[1];
extern CONST(uint16, CAN_CONST_PBCFG) CanInitBasicMsk1[1][2];
extern CONST(uint16, CAN_CONST_PBCFG) CanInitBasicMsk2[1][2];
extern CONST(uint16, CAN_CONST_PBCFG) CanInitBasicCod1[1][2];
extern CONST(uint16, CAN_CONST_PBCFG) CanInitBasicCod2[1][2];
extern CONST(uint32, CAN_CONST_PBCFG) CanBasisAdr[1];
extern CONST(uint32, CAN_CONST_PBCFG) interruptSrc[1];
extern CONST(uint32, CAN_CONST_PBCFG) vimClrReg[1];
extern CONST(uint32, CAN_CONST_PBCFG) vimSetReg[1];
extern CONST(uint8, CAN_CONST_PBCFG) CanNumberOfMsgObj[1];
...
extern VAR(uint32, CAN_VAR_NOINIT) txsendflag[1][4];
...
#define CAN_PRECOMPILE_CRC                   (uint32) 0x990020DDu
/* END of Checksum exclude for
  - DrvCan__baseAsrPrecompileCRC */
