...
#  define Rte_InitValue_NTCB0Enbl_Cnt_lgc (FALSE)
...
#  define Rte_IRead_BVDiag_Per1_NTCB0Enbl_Cnt_lgc() \
  (Rte_Task_10ms_9.Rte_RB.Rte_Ap_BVDiag_BVDiag_Per1.Rte_NTCB0Enbl_Cnt_lgc.value)
