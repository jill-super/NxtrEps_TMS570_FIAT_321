...
#  define Rte_IRead_ePWM2_Per1_CtrldDmpStsCmp_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_ePWM2_ePWM2_Per1.Rte_CtrldDmpStsCmp_Cnt_lgc.value)

#  define Rte_IRead_ePWM2_Per1_DiagStsCtrldDisRmpPres_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_ePWM2_ePWM2_Per1.Rte_DiagStsCtrldDisRmpPres_Cnt_lgc.value)

#  define Rte_IRead_ePWM2_Per1_DiagStsNonRecRmpToZeroFltPres_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_ePWM2_ePWM2_Per1.Rte_DiagStsNonRecRmpToZeroFltPres_Cnt_lgc.value)

#  define Rte_IRead_ePWM2_Per1_RampDwnStatusComplete_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_RB.Rte_Ap_ePWM2_ePWM2_Per1.Rte_RampDwnStatusComplete_Cnt_lgc.value)
