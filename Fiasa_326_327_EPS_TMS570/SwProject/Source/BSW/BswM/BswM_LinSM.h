 ...
 *    Generator:  
 *
 *  Description:  callback header for LinSM
 *  
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
# define BSWM_LINSM_MAJOR_VERSION   0x01u
# define BSWM_LINSM_MINOR_VERSION   0x09u
# define BSWM_LINSM_PATCH_VERSION   0x00u
...
extern FUNC(void, BSWM_CODE) BswM_LinSM_ScheduleEnd_Notification(NetworkHandleType Network, LinIf_SchHandleType Schedule);
