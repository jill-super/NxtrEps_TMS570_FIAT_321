 ...
 *    Generator:  
 *
 *  Description:  callback header for FrSM
 *  
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
# define BSWM_FRSM_MAJOR_VERSION   0x01u
# define BSWM_FRSM_MINOR_VERSION   0x09u
# define BSWM_FRSM_PATCH_VERSION   0x00u
...
extern FUNC(void, BSWM_CODE) BswM_FrSM_StateChangeNotification(NetworkHandleType Network, FrSM_BswM_StateType PreviousState, FrSM_BswM_StateType CurrentState);
