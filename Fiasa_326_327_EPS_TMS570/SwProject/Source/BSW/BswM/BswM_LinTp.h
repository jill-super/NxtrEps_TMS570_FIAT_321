 ...
 *    Generator:  
 *
 *  Description:  callback header for LinTp
 *  
 *********************************************************************************************************************/
 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *  01.00.00  2011-01-17  visdhf                Creation
 ...
 *********************************************************************************************************************/
# define BSWM_LINTP_MAJOR_VERSION   0x01u
# define BSWM_LINTP_MINOR_VERSION   0x09u
# define BSWM_LINTP_PATCH_VERSION   0x00u
...
extern FUNC(void, BSWM_CODE) BswM_LinTp_RequestMode(NetworkHandleType Network, LinTp_ModeType LinTpRequestedMode);
