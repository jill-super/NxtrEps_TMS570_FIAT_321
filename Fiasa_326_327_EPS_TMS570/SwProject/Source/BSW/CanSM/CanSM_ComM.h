...
# include "CanSM_Cfg.h"         /* needed cause of define CANSM_ECU_PASSIVE_MODE */
# include "ComStack_Types.h"    /* needed cause of NetworkHandleType */
# include "ComM_Types.h"        /* needed cause of ComM_ModeType */
# include "Std_Types.h"         /* needed cause of Std_ReturnType and Std_VersionInfoType */
...
# define CCL_ASRSMCAN_COMM_HEADER_VERSION                             0x0121u   /* BCD coded version number */
# define CCL_ASRSMCAN_COMM_HEADER_RELEASE_VERSION                     0x00u    /* BCD coded release version number  */
...
----------------------------------------------------------------------------------------------------------------------
   Input: NetworkHandleType           void CanSM_Init( const CanSM_ConfigType* CanSM_ConfigPtr     CanSm_NetworkHandle,        which network/cluster shall be handled
  ...
  Return: Std_ReturnType              E_OK                        Request was successful
          Std_ReturnType              E_NOT_OK                    Request was not successful, any error occured
----------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------
  ...
  This API function reports the current communiation mode of the specified network.
*********************************************************************************************************************/
