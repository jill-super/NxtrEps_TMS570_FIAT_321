...
# define CCL_ASRSMCAN_SCHM_HEADER_VERSION                             0x0121u   /* BCD coded version number */
# define CCL_ASRSMCAN_SCHM_HEADER_RELEASE_VERSION                     0x00u    /* BCD coded release version number  */
...
----------------------------------------------------------------------------------------------------------------------
  ...
  The API function executes the state machines, the time and the counter.
*********************************************************************************************************************/
...
#endif /* end if not defined ( CANSM_SCHM_H ) */
/**********************************************************************************************************************
  END OF FILE: CanSM_SchM.h
**********************************************************************************************************************/
