...
-----------------------------------------------------------------------------------------------------------------------
  Thomas Kuhl                   Pet          Vector Informatik GmbH
  Stefan Albrecht               Alb          Vector Informatik GmbH
  Daniel Hof                    Dhf          Vector Informatik GmbH
  Michael Schligerski           Mih          Vector Informatik GmbH
-----------------------------------------------------------------------------------------------------------------------
  REVISION HISTORY
-----------------------------------------------------------------------------------------------------------------------
...
#define COMM_TYPES_MINOR_VERSION    24u
...
#define COMM_PN_REMOTE_SLEEP_PENDING        0u
#define COMM_PN_REMOTE_SLEEP_DONE           1u
...
typedef uint8 ComM_SubModeType;

#define COMM_NO_COM             0u
#define COMM_SI_COM             1u
#define COMM_READY_TO_SLEEP     2u
#define COMM_NETWORK_REQUESTED  3u
...
typedef struct
{
  uint8 ByteIndex;      /* Index of the byte in uint8_n array which contains the PNC bit */
  uint8 SetMask;        /* Bit mask to set PNC bit = 1 */
  uint8 ClearMask;      /* Bit mask to clear PNC bit = 0 */
  PNCHandleType PncId;  /* External PNC identifier (ComMPncId) */
} ComM_PncInfoType;
