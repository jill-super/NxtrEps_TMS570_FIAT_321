 ...
 * --------  -------  --------  ------------------------------------------------------------------------------  -------
 * 12/15/14   5       PS        Added XCP DAQ 0xF0 and 0xF1.
 * 								Enabled XCP DAQ 0x010E, 0x010F
 * 03/16/16   6       PS        Enabled XCP DAQ 0x41, 0x42														EA3#6773, EA3#6775
 */
...
const struct EPS_DiagSrv_PIDtbl t_DiagSrv_PIDtbl[D_DIAGSRCVS_COMPIDTBLSIZE_CNT_U16 + D_DIAGSRCVS_PROGPIDTBLSIZE_CNT_U16] =
{
	...
	{0x0030U, NULL_PTR, D_PIDTBL_VARTYPE, 0U, 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVXCP002F_CNT_ENUM}, /* {0x0030U, CM_SrlComEngineSpeed_Rpm_f32, D_PIDTBL_VARTYPE, sizeof(CM_SrlComEngineSpeed_Rpm_f32), 0U, 0U, 0x0000U, D_PIDTBL_READONLY, D_EPSDIAGSRVXCP0030_CNT_ENUM}, Engine Speed (RPM) */
	...
	{0x0041U, CM_Nhet1_DigHwTrqT1_HwNm_S16, D_PIDTBL_VARTYPE, 2U, 0U, 0U, 0x0000U, D_PIDTBL_READWRITE, D_EPSDIAGSRVXCP0041_CNT_ENUM}, /* Digitall HandWheel Torque 1 */
	{0x0042U, CM_Nhet1_DigHwTrqT2_HwNm_S16, D_PIDTBL_VARTYPE, 2U, 0U, 0U, 0x0000U, D_PIDTBL_READWRITE, D_EPSDIAGSRVXCP0042_CNT_ENUM}, /* Digital HandWheel Torque 2 */
	...
	/* Range 0x0054 to 0x00EF available for future use - (156) */
	{0x00F0U, CM_NvMP_Rte_TrqCanc_CogTrqCal, D_PIDTBL_VARTYPE, sizeof(CM_NvMP_Rte_TrqCanc_CogTrqCal), Rte_NvmBlock_TrqCanc_CogTrqCal, 0U, 0x0000U, D_PIDTBL_READWRITE, D_EPSDIAGSRVXCP00F0_CNT_ENUM}, /* NvMP_Rte_TrqCanc_CogTrqCal */
	{0x00F1U, CM_NvMP_Rte_TrqCanc_CogTrqRplComp, D_PIDTBL_VARTYPE, sizeof(CM_NvMP_Rte_TrqCanc_CogTrqRplComp), Rte_NvmBlock_TrqCanc_CogTrqRplComp, 0U, 0x0000U, D_PIDTBL_READWRITE, D_EPSDIAGSRVXCP00F1_CNT_ENUM}, /* NvMP_Rte_TrqCanc_CogTrqRplComp */
	/* Range 0x00F2 to 0x00FE available for future use - (13) */
