...
#   error "The magic number of the generated file <C:/SynergyEA3/Working/VehDyn/tools/contract/Ap_VehDyn/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
