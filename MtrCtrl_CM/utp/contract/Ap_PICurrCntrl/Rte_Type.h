 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_Type.h
 *     Workspace:  C:/Users/nzt9hv/Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_CM-nzt9hv/MtrCtrl_CM/autosar
 *     SW-C Type:  Ap_PICurrCntrl
 *  Generated at:  Tue Apr  7 15:36:23 2015
 *
...
struct Rte_CDS_Ap_PICurrCntrl
{
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PICURRCNTRL_APPL_VAR) PICurrCntrl_Per2_CorrMtrPosElec_Rev_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PICURRCNTRL_APPL_VAR) PICurrCntrl_Per2_DervLambdaAlphaDiag_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PICURRCNTRL_APPL_VAR) PICurrCntrl_Per2_DervLambdaBetaDiag_Volt_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PICURRCNTRL_APPL_VAR) PICurrCntrl_Per2_EstKe_VpRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PICURRCNTRL_APPL_VAR) PICurrCntrl_Per2_EstR_Ohm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PICURRCNTRL_APPL_VAR) PICurrCntrl_Per2_MRFMtrVel_MtrRadpS_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_PICURRCNTRL_APPL_VAR) PICurrCntrl_Per2_MtrCurrDaxRef_Amp_f32;
...
#   if RTE_MAGIC_NUMBER != 1428431217
#    error "The magic number of the generated file <C:/Users/nzt9hv/Documents/Synergy/ccm_wa/ESG_Dev_65/MtrCtrl_CM-nzt9hv/MtrCtrl_CM/utp/contract/Ap_PICurrCntrl/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1428431217
