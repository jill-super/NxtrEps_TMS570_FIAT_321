...
#    error "The magic number of the generated file <C:/Rijvi_Synergy/Working/DigColPs-jzk9cc/DigColPs/utp/contract/Sa_DigColPs/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
