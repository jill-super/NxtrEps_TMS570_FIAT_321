...
struct Rte_CDS_Sa_DigColPs
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_DIGCOLPS_APPL_VAR) DigColPs_Per2_I2CHwAbsPosValid_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_SA_DIGCOLPS_APPL_VAR) DigColPs_Per2_I2CHwAbsPos_HwDeg_f32;
  P2VAR(Rte_DE_ManufModeType, TYPEDEF, RTE_SA_DIGCOLPS_APPL_VAR) DigColPs_Per2_MecState_Cnt_enum;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_DIGCOLPS_APPL_VAR) DigColPs_Per2_TrimComp_Cnt_lgc;
  /* PIM Handles section */
  P2VAR(DigColPsEOLType, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_DigColPsEOL;
...
extern CONSTP2CONST(struct Rte_CDS_Sa_DigColPs, RTE_CONST, RTE_CONST) Rte_Inst_Sa_DigColPs;
...
#    error "The magic number of the generated file <C:/Rijvi_Synergy/Working/DigColPs-jzk9cc/DigColPs/utp/contract/Sa_DigColPs/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
